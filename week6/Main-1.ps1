...
while($operation){
    ...
    elseif($choice -eq 7){
        ...
        $userLogins = getLogInAndOffs (Read-Host -Prompt "How many days would you like to check?")
    ...
    elseif($choice -eq 8){
        ...
        $userLogins = getFailedLogins (Read-Host -Prompt "How many days would you like to check?")
        # TODO: Change the above line in a way that, the days 90 should be taken from the user
    ...
    elseif($choice -eq 9){
        ...
        $userLogins = getFailedLogins (Read-Host -Prompt "How many days would you like to check?")
        $usercount = $userLogins | Group-Object "User" | Select-Object Name,Count | Where-Object {$_.Count -ge 10}
        Write-Host( $usercount | Format-Table | Out-String)
    ...
    #       or a character that should not be accepted. Give a proper message to the user and prompt again.
        ...
        Write-Host "Invalid Prompt Please try again."
    }
